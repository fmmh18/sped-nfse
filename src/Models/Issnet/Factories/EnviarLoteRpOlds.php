...
class EnviarLoteRps extends Factory
{
    public function render(
        ...
        $content = "<EnviarLoteRpsEnvio "
            . 'xmlns="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_enviar_lote_rps_envio.xsd" xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd">';
        $content .= "<LoteRps>";
